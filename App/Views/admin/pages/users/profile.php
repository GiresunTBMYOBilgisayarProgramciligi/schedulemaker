                        ...
                        <div class="card-body box-profile">
                            ...
                            <ul class="list-group list-group-flush mb-3">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-start">
                                    ...
                                    <span class="badge text-bg-primary "><?= $user->getTotalStudents() ?></span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-start">
                                    <div class="ms-3 me-auto">
                                        <b>Haftalık Ders Saati</b>
                                    </div>
                                    <span class="badge text-bg-primary "><?= $user->getWeeklyHours() ?></span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-start">
                                    <div class="ms-3 me-auto">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            <div class="card card-outline card-info mb-3">
                                                ...
                                                <div id="my-schedule-notes-list" class="p-3" data-user-id="<?= (int)$user->id ?>" data-can-manage="<?= \App\Core\Gate::check('canManageNotes', \App\Models\ScheduleNote::class) ? 'true' : 'false' ?>">
