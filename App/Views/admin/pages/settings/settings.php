...
<main class="app-main">
    ...
    <div class="app-content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <form id="addUserForm" action="/ajax/saveSettings" method="post" class="ajaxForm updateForm" title="Ayarları Düzenle">
                        <div class="row g-3">
                            <!-- Left rail -->
                            <div class="col-md-3">
                                <div class="list-group list-group-flush nav nav-pills flex-column" id="settings-nav" role="tablist">
                                    <a href="#general" class="list-group-item list-group-item-action active" data-bs-toggle="pill" role="tab" aria-selected="true">
                                        <i class="bi bi-gear me-2" aria-hidden="true"></i>Genel Ayarlar
                                    </a>
                                    <a href="#lesson" class="list-group-item list-group-item-action" data-bs-toggle="pill" role="tab">
                                        <i class="bi bi-journal-text me-2" aria-hidden="true"></i>Ders Ayarları
                                    </a>
                                    <a href="#exam" class="list-group-item list-group-item-action" data-bs-toggle="pill" role="tab">
                                        <i class="bi bi-pencil-square me-2" aria-hidden="true"></i>Sınav Ayarları
                                    </a>
                            ...
                            <div class="col-md-9">
                                <div class="tab-content">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-6">
                                                        ...
                                                        <select class="form-select" id="settings[lesson][maxDayIndex][value]"
                                                            ...
                                                            <option value="0" <?= $maxDay == 0 ? 'selected' : '' ?>>Pazartesi</option>
                                                            <option value="1" <?= $maxDay == 1 ? 'selected' : '' ?>>Salı</option>
                                                            <option value="2" <?= $maxDay == 2 ? 'selected' : '' ?>>Çarşamba</option>
                                                            <option value="3" <?= $maxDay == 3 ? 'selected' : '' ?>>Perşembe</option>
                                                            <option value="4" <?= $maxDay == 4 ? 'selected' : '' ?>>Cuma</option>
                                                            <option value="5" <?= $maxDay == 5 ? 'selected' : '' ?>>Cumartesi</option>
                                    ...
                                    <div class="tab-pane fade" id="exam" role="tabpanel">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title">Sınav Ayarları</h3>
                                            </div>
                                            <div class="card-body">
                                                <div class="row mb-3">
                                                    <div class="col-md-6">
