...
<div class="schedule-table-container">
    <table class="schedule-table">
        ...
        <tbody>
            ...
            <tr>
                <td class="time-slot"><?= $scheduleRow['slotStartTime']->format('H:i') ?> - <?= $scheduleRow['slotEndTime']->format('H:i') ?></td>
                                ...
                                <?php foreach ($scheduleItem->getSlotDatas() as $slotData) : ?>
                                    <div class="lesson-card <?= $slotData->lesson->getScheduleCSSClass() ?>">
                                        ...
                                        <div class="lesson-meta">
                                            <span class="lesson-lecturer"><i class="fas fa-user-tie"></i> <?= $slotData->lecturer->getFullName() ?></span>
                                            <span class="lesson-classroom"><i class="fas fa-door-open"></i> <?= $slotData->classroom->name ?></span>
                                        </div>
                                    </div>
                                <?php endforeach ?>
                            <?php else : ?>
                                <div class="empty-slot <?= $scheduleItem->getSlotCSSClass() ?>">
                                    ...
                                    <div class="note-icon"
                                        ...
                                        data-bs-content="<?= $scheduleItem->description ?>"
