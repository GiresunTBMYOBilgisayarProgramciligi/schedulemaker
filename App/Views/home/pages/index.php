                ...
                <div class="col-12">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">Bölüm ve Program Ders Programı</h3>
            ...
            <div class="row  mb-3">
                <div class="col-6">
                    <div class="card card-primary card-outline">
                        <!-- .card-header -->
                        <div class="card-header">
                            <h3 class="card-title">Öğreti Üyesi / Görevlisi Ders Programı</h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-lte-toggle="card-collapse">
                                    <i data-lte-icon="expand" class="bi bi-plus-lg"></i>
                                    <i data-lte-icon="collapse" class="bi bi-dash-lg"></i>
                ...
                <div class="col-6">
                    <div class="card card-primary card-outline">
                        <!-- .card-header -->
                        <div class="card-header">
                            <h3 class="card-title">Derslik Ders Programı</h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-lte-toggle="card-collapse">
                                    <i data-lte-icon="expand" class="bi bi-plus-lg"></i>
                                    <i data-lte-icon="collapse" class="bi bi-dash-lg"></i>
