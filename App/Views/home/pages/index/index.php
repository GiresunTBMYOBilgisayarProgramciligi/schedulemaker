                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class=" input-group mb-3">
                                        ...
                                        <button class="btn btn-primary" type="button" id="lecturerScheduleButton" data-only-table="true">
                                            Göster
                                        </button>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        ...
                                        <button class="btn btn-primary" type="button" id="classroomScheduleButton" data-only-table="true">
                                            Göster
                                        </button>
                                    </div>
                                </div>
