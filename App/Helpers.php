...
class FilterValidator
{
    ...
    private function validateType(string $key, $value): void
    {
        ...
        foreach ($possibleTypes as $type) {
            switch ($type) {
                case 'int':
                    if ($this->isIntegerish($value)) return;
                    break;
                case 'string':
                ...
                case 'array':
                    ...
                    break;
                case 'int[]':
                    if (is_array($value) && $this->isArrayOf($value, 'isIntegerish')) return;
                    break;
                case 'string[]':
                    if (is_array($value) && $this->isArrayOf($value, 'is_string')) return;
                    break;
            }
        }
    ...
    {
        if (empty($array)) return true; // Boş dizi geçerlidir.
