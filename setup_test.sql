-- schedulemaker_test Veritabanı Kurulum Dosyası
CREATE DATABASE if not exists schedulemaker_test CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE schedulemaker_test;
...
ALTER TABLE users ADD FOREIGN KEY (program_id) REFERENCES programs (id) ON DELETE SET NULL ON UPDATE CASCADE;
